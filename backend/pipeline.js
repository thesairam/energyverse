...
export function filterRelevance(items, sectorSlug) {
  ...
  return items.filter(item => {
    ...
    if (item.published_at || item.publishedAt) {
      ...
      if (!isNaN(pubDate.getTime()) && pubDate < thirtyDaysAgo) return false
    }
...
// Region keywords for geographic tagging — country-level granularity
export const REGION_KEYWORDS = {
  // ── Specific countries (checked first for precise geo-tagging) ──
  USA: ['united states', 'u.s.', ' us ', 'america', 'texas', 'california', 'florida', 'new york', 'arizona', 'nevada', 'colorado', 'georgia', 'ohio', 'michigan', 'illinois', 'washington state', 'oregon', 'virginia', 'north carolina', 'tennessee', 'doe', 'ferc', 'ira ', 'congress', 'white house', 'biden', 'nrel', 'eia '],
  Canada: ['canada', 'canadian', 'ontario', 'quebec', 'alberta', 'british columbia', 'ottawa', 'toronto'],
  UK: ['uk ', ' uk,', 'united kingdom', 'britain', 'british', 'england', 'scotland', 'wales', 'london', 'ofgem', 'national grid uk', 'desnz'],
  Germany: ['germany', 'german', 'berlin', 'munich', 'frankfurt', 'deutsche', 'energiewende', 'bundesnetzagentur', 'siemens'],
  France: ['france', 'french', 'paris', 'edf ', 'totalenergies', 'engie'],
  Spain: ['spain', 'spanish', 'madrid', 'barcelona', 'iberdrola'],
  Italy: ['italy', 'italian', 'rome', 'milan', 'enel'],
  Netherlands: ['netherlands', 'dutch', 'holland', 'amsterdam', 'rotterdam'],
  Denmark: ['denmark', 'danish', 'copenhagen', 'vestas', 'ørsted', 'orsted'],
  Norway: ['norway', 'norwegian', 'oslo', 'equinor', 'statkraft'],
  Sweden: ['sweden', 'swedish', 'stockholm', 'vattenfall', 'northvolt'],
  Finland: ['finland', 'finnish', 'helsinki', 'fortum'],
  ...
  China: ['china', 'chinese', 'beijing', 'shanghai', 'guangdong', 'shenzhen', 'longi', 'jinko', 'trina', 'catl', 'byd', 'cgn', 'cnnc', 'sinopec'],
  India: ['india', 'indian', 'delhi', 'mumbai', 'bangalore', 'adani', 'tata', 'reliance', 'ntpc', 'mnre'],
  Japan: ['japan', 'japanese', 'tokyo', 'osaka', 'jera', 'tepco', 'softbank energy'],
  'South Korea': ['south korea', 'korean', 'seoul', 'samsung sdi', 'lg energy', 'hyundai', 'kia', 'hanwha', 'kepco'],
  Australia: ['australia', 'australian', 'sydney', 'melbourne', 'queensland', 'aemo', 'neoen'],
  ...
  UAE: ['uae', 'emirates', 'abu dhabi', 'dubai', 'masdar'],
  'Saudi Arabia': ['saudi', 'riyadh', 'neom', 'aramco', 'acwa power'],
  Qatar: ['qatar', 'doha'],
  Kuwait: ['kuwait'],
  Oman: ['oman', 'muscat'],
  ...
  'South Africa': ['south africa', 'johannesburg', 'cape town', 'eskom'],
  Nigeria: ['nigeria', 'nigerian', 'lagos', 'abuja'],
  Morocco: ['morocco', 'moroccan', 'rabat', 'masen'],
  ...
  Mexico: ['mexico', 'mexican', 'mexico city', 'cfe '],
  Brazil: ['brazil', 'brazilian', 'são paulo', 'brasilia', 'rio de janeiro', 'petrobras'],
  ...
  // ── Macro regions (fallback) ──
  NAM: ['north america'],
  EMEA: ['europe', 'eu ', 'european union', 'european commission'],
  APAC: ['asean', 'asia', 'asia-pacific', 'asia pacific'],
  MEA: ['africa', 'middle east', 'mena', 'sub-saharan'],
  LATAM: ['latin america', 'south america', 'caribbean', 'central americaesnetzagentur', 'siemens'],
  France: ['france', 'french', 'paris', 'edf ', 'totalenergies', 'engie'],
  Spain: ['spain', 'spanish', 'madrid', 'barcelona', 'iberdrola'],
  Italy: ['italy', 'italian', 'rome', 'milan', 'enel'],
  Netherlands: ['netherlands', 'dutch', 'holland', 'amsterdam', 'rotterdam'],
  ...
  APAC: ['asean', 'asia', 'asia-pacific', 'asia pacific'],
  MEA: ['africa', 'middle east', 'mena', 'sub-saharan'],
  LATAM: ['latin america', 'south america', 'caribbean', 'central america'],
}
